...
- [Prompts](/mcp/prompts) — the seven DTPR Agent Skills plus their reference documents, served as MCP prompts so any MCP-aware harness can load them without a Claude-specific install.

## Tools at a glance

| Tool | Purpose |
|------|---------|
| [`list_schema_versions`](/mcp/tools/list-schema-versions) | Discover available schema releases. |
