...
| `meta.version` | Canonical schema version, e.g. `dtpr@2026-09-01-beta`. |
  ...
  "errors": [
    {
      ...
      "message": "Element 'missing_element' not found in dtpr@2026-09-01-beta.",
      "path": "elements[0].element_id",
      "fix_hint": "Use list_elements to enumerate available elements."
    }
  ],
  "meta": { "version": "dtpr@2026-09-01-beta" }
}
```
