...
description: Validate a ResolvedDatachain against its referenced schema.
---
...
MCP sibling to [POST /schemas/:version/validate_resolved](/rest/validate-resolved). Validates a snapshot-pinned `ResolvedDatachain` end-to-end:
