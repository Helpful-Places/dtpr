...
|-------|------|----------|---------|-------------|
| `version` | `string` | yes | — | Schema version, e.g. `"dtpr@2026-09-01-beta"`. |
...
```json
{
  ...
  "data": {
    ...
    "datachain_type": { "id": "dtpr", "categories": [...] },
...
curl -s https://api.dtpr.io/mcp \
  ...
  --data '{
    ...
    "params":{
      "name":"get_schema",
      "arguments":{"version":"dtpr@2026-09-01-beta"}
    }
  }'
```
...
```json [tools/call]
{
  ...
  "params": {
    "name": "get_schema",
    "arguments": { "version": "dtpr@2026-09-01-beta", "include": "full" }
  }
}
```
::
