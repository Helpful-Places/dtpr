...
- **Authoring teams using Claude** — [`/plugin install dtpr`](/plugin/install) adds seven Agent Skills that describe AI systems, iterate on the DTPR schema, design element icons, translate locales, and grade content for public comprehension.
...
- [Claude plugin](/plugin) — the authoring studio that drives all of the above from inside Claude.
