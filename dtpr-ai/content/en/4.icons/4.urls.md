...
|------|---------|---------|
| `icon.svg` | `/api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example/icon.svg` | `default` variant. |
| `icon.dark.svg` | `/api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example/icon.dark.svg` | `dark` variant. |
| `icon.<context>.svg` | `/api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example/icon.commercial.svg` | Colored variant whose `<context>` matches a category `context.value.id`. |
...
```bash
curl -s https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example \
...
{
  "data": {
    "url": "/api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example/icon.dark.svg",
