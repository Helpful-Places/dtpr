...
|------|---------|---------|
| `icon.svg` | `/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.svg` | `default` variant. |
| `icon.dark.svg` | `/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.dark.svg` | `dark` variant. |
| `icon.<context>.svg` | `/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.deployer.svg` | Colored variant whose `<context>` matches a category `context.value.id`. |
...
```bash
curl -s https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization \
  | jq '.element.icon_variants'
# [ "default", "dark", "vendor", "vendor.dark", "deployer", "deployer.dark" ]
```
...
{
  "data": {
    "url": "/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.dark.svg",
    "content_type": "image/svg+xml",
    "variant": "dark",
    "valid_variants": ["default", "dark", "vendor", "vendor.dark", "deployer", "deployer.dark"]
  }
}
```
