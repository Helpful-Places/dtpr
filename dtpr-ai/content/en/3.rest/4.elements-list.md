...

{
  ...
  "elements": [
    { "id": "employment", "title": [{"locale":"en","value":"Employment"}], "category_id": "purpose" }
  ],
  "meta": {
    "total": 127,
    "returned": 50,
...
```bash [curl]
# first page
curl -s "https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements?fields=all&limit=50"

# follow-up page
curl -s "https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements?fields=all&limit=50&cursor=eyJvZmZzZXQiOjUwfQ=="
```

```http [wire]
GET /api/v2/schemas/dtpr@2026-09-01-beta/elements?category_id=purpose&query=camera&locales=en&limit=25 HTTP/1.1
Host: api.dtpr.io
```
::
