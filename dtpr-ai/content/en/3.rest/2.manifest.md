...
|------------|-------------|
| `version` | Canonical schema version, e.g. `dtpr@2026-09-01-beta`. |
...
::code-group
```bash [curl]
curl -s -i https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/manifest
```

```http [wire]
GET /api/v2/schemas/dtpr@2026-09-01-beta/manifest HTTP/1.1
Host: api.dtpr.io
```
::
