...
```
/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.svg           # default
/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.dark.svg      # dark
/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.deployer.svg  # context-colored
```
...
```bash [curl — symbol]
curl -s -i https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/symbols/building.svg
```

```bash [curl — composed]
curl -s -i https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization/icon.dark.svg
```
::
