...
::code-group
```bash [curl]
curl -s "https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example?locales=en"
```

```http [wire]
GET /api/v2/schemas/dtpr@2026-09-01-beta/elements/purpose.example HTTP/1.1
Host: api.dtpr.io
```
::
