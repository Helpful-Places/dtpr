...

{
  ...
  "element": {
    "id": "organization",
    "title": [{"locale":"en","value":"Organization"}],
    "description": [{"locale":"en","value":"A company, nonprofit, or other non-government organization."}],
    "category_id": "accountable",
    "symbol_id": "building",
    "icon_variants": ["default", "dark", "vendor", "vendor.dark", "deployer", "deployer.dark"],
    "variables": []
  }
}
```
...
::code-group
```bash [curl]
curl -s "https://api.dtpr.io/api/v2/schemas/dtpr@2026-09-01-beta/elements/organization?locales=en"
```

```http [wire]
GET /api/v2/schemas/dtpr@2026-09-01-beta/elements/organization HTTP/1.1
Host: api.dtpr.io
```
::
