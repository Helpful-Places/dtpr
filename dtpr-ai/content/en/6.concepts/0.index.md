...
- [Versions & releases](/concepts/versions-and-releases) — Canonical ids, status, and stability.
- [Content hash](/concepts/content-hash) — How agents detect schema updates.
- [Shape contract](/concepts/shape-contract) — Advisory mapping from icon shapes to category kinds.
- [Subchains](/concepts/subchains) — Grouping categories into named flows on a datachain.
