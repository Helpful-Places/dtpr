...
::callout{type="info"}
**[`dtpr-skills.zip` (v0.3.1)](/skills/0.3.1/dtpr-skills.zip)** — combined bundle (one `.skill` file per skill plus an `INSTALL.txt`).
::
...
- [`dtpr-describe-system.skill`](/skills/0.3.1/dtpr-describe-system.skill)
- [`dtpr-datachain-structure.skill`](/skills/0.3.1/dtpr-datachain-structure.skill)
- [`dtpr-category-audit.skill`](/skills/0.3.1/dtpr-category-audit.skill)
- [`dtpr-element-design.skill`](/skills/0.3.1/dtpr-element-design.skill)
- [`dtpr-symbol-design.skill`](/skills/0.3.1/dtpr-symbol-design.skill)
- [`dtpr-translate.skill`](/skills/0.3.1/dtpr-translate.skill)
- [`dtpr-comprehension-audit.skill`](/skills/0.3.1/dtpr-comprehension-audit.skill)
