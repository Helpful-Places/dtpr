...
- **Authoring teams using Claude** — [`/plugin install dtpr`](/plugin/install) adds five skills that describe AI systems, iterate on the DTPR schema, and grade content for public comprehension.
