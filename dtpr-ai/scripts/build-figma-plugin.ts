...
function installReadme(version: string): string {
  return [
    ...
    '',
    'A full build fetches ~470 icons and takes roughly two minutes; the',
    'plugin paces itself to stay inside the API rate limit. The "Default',
    'context only" and "Light theme only" options make that much faster',
    'when you only need a quick refresh.',
    '',
