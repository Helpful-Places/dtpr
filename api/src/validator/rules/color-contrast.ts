...
/**
 * Warning rule: every `ContextValue.color` must produce enough contrast
 * with the compositor's chosen inner color (`#000` or `#FFF`) to meet
 * WCAG AA (4.5:1). Rule 13 already rejects non-hex colors; we skip
 * those entries rather than double-reporting.
 *
