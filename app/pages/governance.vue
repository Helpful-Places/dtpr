<template>
    <div class="app-container mt-12">
        <Card class="bg-dtpr-green text-dtpr-green-100">
            ...
            <ul>
                <li><strong>Access DTPR Open Source Resources: <NuxtLink class="underline" to="https://github.com/Helpful-Places/dtpr">DTPR Github</NuxtLink></strong></li>

                <li><strong>View historical changes to the DTPR Standard: </strong><NuxtLink class="underline" to="https://github.com/Helpful-Places/dtpr/issues">DTPR Github Repository Issues</NuxtLink></li>
            </ul>
        </Card>
        
        <Card class="flex flex-wrap gap-8 mt-8">
            <div class="flex flex-wrap w-full gap-6 justify-around">
                <COPC-Card
                    class="basis-full md:basis-1/3 font-normal"
                    url="#"
                    imageFile="CoPC-Headshots/charles.png"
                    imageAlt="Headshot of Charles Finley"
                >
                    <strong>Charles Finley: </strong> The DTPR Community of Practice Council is led by Charles Finley, the DTPR Governance Lead.
                </COPC-Card>

                <COPC-Card
                    class="basis-full md:basis-1/3 font-normal"
                    url="#"
                    imageFile="CoPC-Headshots/Dana.jpg"
                    imageAlt="Headshot of Dana"
                >
                    <strong>Dana Chermesh-Reshef, Founder & CEO, inCitu</strong>
                    Dana is an architect specialized in infill development and housing policies, turned urban data scientist (NYU CUSP '18). In 2020, Dana founded inCitu: a startup on the mission to democratize city planning through augmented reality (AR).
Prior to inCitu Dana worked at the New York City Department of City Planning (DCP), her research on the feasibility of Tel-Aviv’s city center rezoning was published in “The Marker” newspaper and she is a frequent lecturer on Smart Cities’ next frontier.
...
Author of numerous articles and books on public data management, in 2017 he published “Le big data des territoires” (Editions FYP), which inspired French public organizations to develop their data strategies. In 2020, he also published “ Ne laissez pas Google gérer nos villes!” a plea to learn from the Google City project in Toronto (Editions de l'Aube). In 2021, he co-wrote and coordinated the production of an official report submitted to the French government, “ De la smart city à la réalité des territoires connectés ” (From the smart city to the reality of connected territories ), which provides an unprecedented overview of the uses of data in the cities. In 2022, he produced a research paper for the french Institute of International Relations entitled “Neither surveillance nor algorithmic consumerism: towards an alternative European model for smart cities”.
            ...
            <div class="flex flex-wrap w-full gap-6 justify-around">
                <COPC-Card
                    class="basis-full md:basis-1/3 font-normal"
                    url="#"
                    imageFile="CoPC-Headshots/Joanna.jpg"
                    imageAlt="Headshot of Joanna"
                >
                    <strong>Joanna Kraatz: </strong>With progressive experience in smart city development and project management, Joanna is currently leading projects for the NSW Smart Places Program Team, leveraging strategic planning skills refined while serving as Future Innovation Officer for Wollondilly Shire Council. Her core competencies include collaboration, transformative project delivery and agile management, ensuring projects align with the mission of creating innovative, sustainable places. Joanna is committed to integrating smart technology and data insights to deliver tangible benefits to the communities through collective impact.
                ...
                <COPC-Card
                    class="basis-full md:basis-1/3 font-normal"
                    url="#"
                    imageFile="CoPC-Headshots/Mike.jpg"
                    imageAlt="Headshot of Mike"
                >
                    <strong>Mike Melinyshyn (CPA CMA, MMAI, MBA)</strong> Mike Melinyshyn (CPA CMA, MMAI, MBA) serves as CFO, Director of Corporate Services &amp;
